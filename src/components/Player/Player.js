      ...
      tracks: [
        {
          ...
          duration: 210,
          artwork:
            'https://is5-ssl.mzstatic.com/image/thumb/Music/59/db/b5/mzi.nloomwwj.jpg/268x0w.jpg',
        },
        {
          name: 'Beer',
          artist: 'Reel Big Fish',
          ...
          duration: 233,
          artwork:
            'https://upload.wikimedia.org/wikipedia/en/9/9d/Reel_Big_Fish_-_We%27re_Not_Happy_%27til_You%27re_Not_Happy_cover.jpg',
        },
        {
          ...
          duration: 289,
          artwork:
            'https://upload.wikimedia.org/wikipedia/en/9/95/Streetlight_Manifesto_-_Somewhere_in_the_Between.jpg',
        },
        {
        ...
        },
        {
          ...
          duration: 163,
          artwork:
            'https://upload.wikimedia.org/wikipedia/en/f/f9/Reel_Big_Fish_-_Cheer_Up%21_cover.jpg',
        },
      ],
    };
  }
        ...
        <div className='wrapper'>
          <article className={['player', sliding].join(' ')}>
            <div
              ...
              style={{ backgroundImage: 'url(' + prevTrack.artwork + ')' }}
            ></div>
            <div
            ...
            <div
              ...
              style={{ backgroundImage: 'url(' + nextTrack.artwork + ')' }}
            ></div>
            <section className='player__art'>
              ...
              <button
                className='button toggle-playlist'
              ...
              <Playlist
                ...
                isVisible={this.state.viewMode === 'playlist'}
